        ...
        <Card>
            ...
            <CardContent className="space-y-2">
                ...
                <CardDescription className="text-sm text-muted-foreground mb-4">
                    Administra la configuración de privacidad y seguridad de tu
                    cuenta
                </CardDescription>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Permite que lo reclutadores vean tu perfil
                        </p>
                    </div>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        <h3 className="text-sm text-heading font-semibold">
                            Recibir notoficaciones por correo
                        </h3>
                        <p className="text-sm text-muted-foreground">
                            Recibe notificaciones sobre nuevas ofertas de
                            trabajo
                        </p>
                    </div>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Seleccione el tema de su preferencia
                        </p>
                    </div>
                    <Select defaultValue="claro">
                        ...
                        <SelectContent>
                            ...
                            <SelectItem disabled value="oscuro">
                                Oscuro
                            </SelectItem>
                            <SelectItem disabled value="sistema">
                                Sistema
                            </SelectItem>
                        </SelectContent>
                    </Select>
                            ...
                            <DialogContent>
                                ...
                                <div className="grid gap-4 py-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="password" type="password" placeholder="Contraseña actual" />
                                    </div>
                                    <div className="space-y-2">
