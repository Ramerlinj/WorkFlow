...
function Profile({ profile, user }: ProfileFullProps) {
    ...
    const [IsOpenEdirProfile, setIsOpenEditProfile] = useState(false);
                    ...
                    <div className="w-full p-4 mt-16">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex flex-row gap-0.5 ml-4">
                                ...
                                <p className="text-light text-size-medium mr-5">
                                    Agregar a la db direccion addres
                                </p>
                                ...
                                <Dialog open={IsOpen} onOpenChange={setIsOpen}>
                                    ...
                                    <DialogContent className="sm:max-w-[425px]">
                                        <DialogHeader>
                                            ...
                                            <DialogDescription>
                                                El usuario no ha subido un CV a su perfil, por lo que no se puede
                                                mostrar.
                                            </DialogDescription>
                                        </DialogHeader>
                                        <DialogClose asChild>
            ...
            <div className="flex flex-row justify-between items-start gap-4 mt-10">
                <div className="flex flex-col gap-4 w-1/3">
                    <Card>
                        ...
                        <CardContent className="text-secondary text-sm">{about_me}</CardContent>
                    </Card>
